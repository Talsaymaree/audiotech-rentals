...
const Contact = () => {
  document.title ="Contact - AudioTech Rentals"; 
  document.getElementsByTagName("META")[2].content="Your Premier Destination for Audio Equipment Rentals and DJ Services. Reach Out Today to Elevate Your Sound Experience. Contact Us Now!";
  ...
  return (
    ...
    <div className={"mx-auto my-0 prose md:prose-md text-left 2xl:max-w-screen-lg max-h-screen-lg mx-auto text-1xl"}>
      <h3>Contact Us:</h3>
      <p className={'text-sm'}>Please send us a message and we will contact you via email as soon as we can.</p>
    </div>
